...
import LogoSherwood2 from '../../assets/SherwodLogo2.png'
// import UserLogo from '../assets/usuario-logo.png'
import { Link } from 'react-router-dom';
function Footer() {
    return (
        <footer class=" bg-neutral-950 w-full">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 ">
                <div class="md:flex md:justify-between">
                    <div class="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center relative w-full h-full py-0">
                            <img src={LogoSherwood2} class="h-28 w-auto my-4" alt="Logo" />
                        </Link>
                    </div>
                ...
                <div class="sm:flex sm:items-center sm:justify-between text-white">
                    ...
                    <div class="flex mt-4 sm:justify-center sm:mt-0">
                        <a href="#" class="transition hover:scale-125 hover:text-blue-300">
                            <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd" />
                            </svg>
                            <span class="sr-only">Facebook page</span>
                        </a>
                        <a href="#" class="transition hover:scale-125 hover:text-blue-300 ms-5">
