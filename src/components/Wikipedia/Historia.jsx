...
const Historia = () => {
    ...
    return (
        <div className="p-6 max-w-3/4 mx-auto ">
            <h1 className="text-3xl font-TrajanProBold text-center mb-6 text-white ">Historia de Sherwood Dungeon</h1>

            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood">Orígenes de Sherwood Dungeon</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood">Sherwood Forest / Sherwood Temples</h2>
                <p class="text-gray-400 my-4">
                ...
                <div class="grid grid-cols-1 gap-4 w-auto my-6 justify-center">
                    <div class="flex items-center justify-center">
                        <iframe class=" aspect-video rounded-lg border-dungeon h-80 w-auto"
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood">Sherwood Classic / Sherwood Castle</h2>
                <p class="text-gray-400 my-4">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood">Sherwood Dungeon / Sherwood Alpha</h2>
                <p class="text-gray-400 my-4">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood">Actualizaciones y Evolución</h2>
                <p class="text-gray-400 my-4">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood">Sherwood Alpha</h2>
                <p class="text-gray-400 my-4">
