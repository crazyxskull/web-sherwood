...
const Comandos = () => {
    return (
        <div className="lg:p-2 lg:w-4/5 p-1 w-full mx-auto text-white">
            <h1 className="text-5xl font-Deutsch text-center mb-6 text-textSherwood text-shadow">Comandos</h1>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">Sumario</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Teleport + Num</h2>
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Level + Num</h2>
                <p className="text-gray-300 mb-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Join + Num</h2>
                <p className="text-gray-300">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Who</h2>
                <p className="text-gray-300">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ F</h2>
                <p className="text-gray-300">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Fps</h2>
                <p className="text-gray-300">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Help</h2>
                <p className="text-gray-300">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Camera</h2>
                <p className="text-gray-300 mb-2">
            ...
            <section className="mb-6">
                <h2 className="text-2xl font-TrajanProReg text-redSherwood mb-2">/ Logout</h2>
                <p className="text-gray-300">
