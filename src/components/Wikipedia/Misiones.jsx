    ...
    return (
        <div >
            <div className="flex flex-col p-4 bg-gray-900">
                ...
                <div className=" h-auto w-full bg-gray-950/70 rounded-lg flex justify-end items-center">
                    <button type="button"
                ...
                <div class="grid grid-cols-2 gap-4">
                    {misionesData.map(mision => (  // Itera sobre el array de datos
                        <div key={mision.id} className="grid grid-cols-3 h-auto w-full my-4 bg-gray-950/40 rounded-lg hover:brightness-130">
