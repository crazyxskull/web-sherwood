...
const Wiki = () => {
    ...
    return (
        ...
        >
            <div className="flex w-full bg-gray-950/70">
                <div className="w-58">
                    <Sidebar />
                </div>
                    ...
                    <div className="w-full min-h-screen">
                        <div className="relative right-0">
                            ...
                            <div data-tab-content="" className="">
                                ...
                                <div className={`p-4 bg-fixed ${activeTab === 'comandos-tab' ? '' : 'hidden'}`} id="comandos-tab" role="tabpanel"
                                    style={{ backgroundImage: `url(${fondoCaverna})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                                    <Comandos />
                                </div>
                                <div className={`p-4 bg-fixed min-h-screen${activeTab === 'adicional-tab' ? '' : 'hidden'}`} id="adicional-tab" role="tabpanel"
                                    style={{ backgroundImage: `url(${fondoCastle})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
